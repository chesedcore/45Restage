...
func _ready() -> void:
	...
	##i changed some of this shit up: replace with await find_parent('EditorView')
	var parent_node := find_parent('EditorView')
	if not parent_node: return
	if not timeline_editor.editors_manager: return
